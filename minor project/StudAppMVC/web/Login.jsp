                ...
                <div class="mbr-navbar__column mbr-navbar__menu">
                    <nav class="mbr-navbar__menu-box mbr-navbar__menu-box--inline-right">
                        <div  class="mbr-navbar__column">
                            <ul class="mbr-navbar__items mbr-navbar__items--right float-left mbr-buttons mbr-buttons--freeze mbr-buttons--right btn-decorator mbr-buttons--active mbr-buttons--only-links"><li class="mbr-navbar__item"><a class="mbr-buttons__link btn text-white" href="index.html">HOME</a></li> <li class="mbr-navbar__item"><a class="mbr-buttons__link btn text-white" href="index.html#content5-b">ABOUT US</a></li> <li class="mbr-navbar__item"><a class="mbr-buttons__link btn text-white" href="register.jsp">REGISTER HERE </a></li><li class="mbr-navbar__item"><li class="mbr-navbar__item"><a class="mbr-buttons__link btn text-white" href="index.html#contacts2-i">CONTACT US</a></li></ul>                            
        ...
        <div id="main">
            ...
            <div id="login">
                ...
                <form action="LoginCheck.jsp">
                 <h2>Login Here!</h2>
            <input type="text" name="unm" size="50"
                   value="<%
                   Cookie c[] = request.getCookies();
                   if(c.length!=0){
                       for(Cookie ck : c){
                           if(ck.getName().equals("UNM"))
            ...
            <br>
            <input type="password" name="upass" size="50"
            ...
            <br>
            <input type="checkbox" name="c1">Remember Me
            <br>
            <input type="submit" name="log" value="Login" size="50">
        </form>
            </div> <!-- login -->
...
<strong>CONTACT</strong> +91 731 2582375, 2546333<br>&nbsp;&nbsp;<br></p>
  ...
  <script src="assets/mobirise-gallery/script.js"></script><!-- main -->
    </body>
</html>
