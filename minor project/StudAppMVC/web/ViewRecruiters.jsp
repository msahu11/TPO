...
<%
    RecruiterAdapter sa = new RecruiterAdapter();
    
    List<Recruiter> rlist = sa.viewRecruiter(a);
    
    
    for(Recruiter s:rlist){
   ...
   %>
        ...
        <tr>
            ...
            <td><%=s.getDoa()%></td>
            <td><a href="Apply.jsp?a=<%=name%>"><img src='apply.png' width="80" height="30"></a>
