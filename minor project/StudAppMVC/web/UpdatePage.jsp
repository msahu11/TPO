<%-- 
    Document   : UpdatePage
    Created on : 24 Sep, 2017, 7:27:32 PM
    Author     : rachee
--%>
...
<body onload="document.registration.userid.focus();">  
    ...
    <div class="mbr-navbar__section mbr-section">
        ...
        <form action="Update.jsp" method="post" >
              <textarea rows="10" cols="100" name="comment"  placeholder="Enter Newsfeed...">
</textarea><br>



<input type="text" name="image" size="100" placeholder="enter path for image" required/>
<br>
<input type="submit" value="Submit" name="b" id="b1" />
