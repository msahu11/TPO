...
<script type="text/javascript">
    function allNumeric()  
    {  
    var uzip = document.updatec.cont; 
                ...
                <div class="mbr-navbar__column mbr-navbar__menu">
                    <nav class="mbr-navbar__menu-box mbr-navbar__menu-box--inline-right">
                        <div  class="mbr-navbar__column">
                            <ul class="mbr-navbar__items mbr-navbar__items--right float-left mbr-buttons mbr-buttons--freeze mbr-buttons--right btn-decorator mbr-buttons--active mbr-buttons--only-links"><li class="mbr-navbar__item"><a class="mbr-buttons__link btn text-white" href="ProfileStudent.jsp">PROFILE</a></li> <li class="mbr-navbar__item"><a class="mbr-buttons__link btn text-white" href="UpdateProfile.jsp">UPDATE PROFILE</a></li> <li class="mbr-navbar__item"><a class="mbr-buttons__link btn text-white" href="View.jsp">VIEW RECRUITERS & APPLY </a>
...
<h1 align="center"> Update Contact Details!</h1>
   <form name='updatec' action="UpdateC.jsp" onSubmit="return allNumeric();">  
                            <input type="text" name="cont" placeholder="Enter Contact to update..." size="50"/>
                            <br>
                   <input type="submit" name="scont" value="submit "/>
                   <br>
   </form>

<br>
                      <form name='updatee' action="UpdateE.jsp">  

                          <input type="email" name="eml" placeholder="Enter Email to update..." size="50" required/>
            <br>
             <input type="submit" name="seml" value="submit "/>
    </form>
<br>      
      <br>      
